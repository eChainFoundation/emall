	...
	<article class="mar-b">
		<ul>
			...
			<li class="list-height bg-white f-s4">
				<div class="auto">
					<div class="t-box list-height">
					<input type="hidden" id="insuranceId" name="insuranceId" value="${insurance.id}"></input>
						<div class="t-box-flex1">${insurance.insuranceName}</div>
						<p>×1</p>
					</div>
				</div>
			</li>
...
<footer class="t-box f-s4" id="footer">
	...
	<div class="t-box-flex1"><button type="button" id="submitOrder" class="color-white bg-purple-blue order-btn">提交订单</button></div>
</footer>
...
$(function(){
	$("#submitOrder").unbind("click").bind("click", function() {
		...
		clickUrl("/order/buy_goods.action?productId="+productId+"&insuranceId="+insuranceId);
	});
})
