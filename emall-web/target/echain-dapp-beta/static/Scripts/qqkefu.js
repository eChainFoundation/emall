...
var urlroot = "/Areas/Site/Content/Images2/QQKeFu/";
var tOut = -1;
var drag = false;
var g_safeNode = null;
lastScrollY = 0;
...
if(kfguin)
{
  rightDivHtml = '<div id="rightDiv" style="position:absolute; top:100px; right:1px;z-index:100;">';
  ...
  if(type==1 && kf_getCookie('hasshown')==0)
  {
      ...
      welcomeword = kf_processWelcomeword(welcomeword);
  	  ...
  	  //允许滚动请放开本行     window.setTimeout("kf_sleepShow()",2000);
 
      //kf_sleepShow();
  }
 //允许滚动请放开本行 window.setTimeout("kf_moveWithScroll()",1);
