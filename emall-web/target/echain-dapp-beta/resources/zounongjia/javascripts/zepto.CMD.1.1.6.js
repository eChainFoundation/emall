...
/* define('Zepto',[],function(require, exports, module){	module.exports = Zepto;
}); */
...
function(a, b) {
    ...
    a.fn.anim = function(c, d, e, f, s) {
        ...
        A = !1;
        if (d === b && (d = a.fx.speeds._default / 1e3), s === b && (s = 0), a.fx.off && (d = 0), "string" == typeof c) u[m] = c,
        u[n] = d + "s",
        u[p] = s + "s",
        u[o] = e || "linear",
        z = a.fx.animationEnd;
            ...
            w && (u[h] = w, v.push(h)),
            d > 0 && "object" == typeof c && (u[i] = v.join(", "), u[j] = d + "s", u[l] = s + "s", u[k] = e || "linear")
        }
        return y = function(b) {
 ...
 * @Date     2015å¹´2æœˆ13æ—¥
 * @Version  1.0.0
 * @Use      FastClick.js è§£å†³clickåœ¨æ‰‹æœºç‚¹å‡»å»¶æ—¶300æ¯«ç§’çš„é—®é¢˜
 */
...
function() {
    ...
    function a(b, d) {
        ...
        this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = d.touchBoundary || 10, this.layer = b, this.tapDelay = d.tapDelay || 200, this.tapTimeout = d.tapTimeout || 700, !a.notNeeded(b)) {
            ...
            "function" == typeof b.onclick && (e = b.onclick, b.addEventListener("click",
            function(a) {
                e(a)
            },
            !1), b.onclick = null)
