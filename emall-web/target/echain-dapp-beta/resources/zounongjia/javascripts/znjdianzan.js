 	               ...
 	               $.ajax({
 	                   ...
 	                   success: function(data) { 
 		                   ...
 		                   for(var loop = 0 ; loop <dataList.length;loop++ ){
	 		                	...
	 		                	list_content+= "<li class=\"pageList clearfix\">" + "<dt><a href=\"" + "/Zounongjia/index/"
	 		             		...
	 		             		list_content+= "<h2 class=\"f16\">" + cutString(ele.userName,8) + "</h2>";
		 		   				...
		 		   				list_content+= "</a></h2><p class=\"cGrey mt5\">点赞时间：" + ele.createTime
		 							+ "</p><div class=\"list_1Foot\"><a class='deleteIcon btn_1' href='javascript:;' dianzan_id='"
		 							+ ele.id + "' >取消点赞</a></div></dd></li>";
	 	                 ...
	 	                 $(".deleteIcon").each(function() {
			       	            var _this = $(this);
			       	            var id = _this.attr("dianzan_id");
			       	            _this.unbind("click").bind("click", function() {
			       	             $.ajax({
				 	                   url: "/MyZounongjia/deleteZnjUserDianzan",
				 	                   data:"dianzanId="+id,
				 	                   dataType:"json",  
				 	                   cache: false,
				 	                   success: function(data) {
