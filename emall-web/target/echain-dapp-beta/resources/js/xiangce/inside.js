...
var G = {
    ...
    set: {
        ...
        dataTables: {
            ...
            "oLanguage": {
                "sLengthMenu": " <span>每页显示</span>_MENU_ <span>条记�?</span> ",
                "sZeroRecords": "对不起，查询不到任何相关数据",
                "sInfo": "当前显示 _START_ �? _END_ 条，�? _TOTAL_ 条记�?",
                "sInfoEmtpy": "找不到相关数�?",
                "sInfoFiltered": "数据表中共为 _MAX_ 条记�?)",
                "sProcessing": "正在加载�?...",
    ...
    common: function () {
        ...
        $talbecheckbox.length > 0 && $("table.ajax-checkbox input[type='checkbox'][name='show']").click(function () {
            var t = $(this),
				...
				u, f;
            if (e) {
                if (u = $("table.ajax-checkbox input[type='checkbox'][name='show']:checked").length, n && n != 0 && (f = "最多勾选{0}�?", u > n)) return G.ui.tips.info(f.format(n)), !1;
                $.post(r, {
                    id: i,
                    ck: 1
                }, function () {
