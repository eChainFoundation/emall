...
function isDigit(value){
		regValue = "^(([0-9]+\\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\\.[0-9]+)|([0-9]*[1-9][0-9]*))$"; 
        var   re   =   new   RegExp(regValue); 
        if(value=="" || value.match(re)==null) {
             return false;
         }
        return true;
...
function setCookie(name, value) {
    document.cookie = name + "=" + escape(value) + ";id=zounongjia;path=/;";
}
...
function setCookieByExpires(name, value, seconds) { 
    ...
    document.cookie = name + "=" + escape(value) + ";id=zounongjia;path=/;expires=" + exp.toGMTString()
}
...
function delCookie(name) {
    ...
    if (cval != null) {
        document.cookie = name + "=" + cval + ";id=zounongjia;path=/;expires=" + exp.toGMTString() + ";" 
    }
}
