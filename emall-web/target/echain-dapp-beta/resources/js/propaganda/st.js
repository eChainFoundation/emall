 ...
 * author zzy
 */
var st_config = {"memc":"","memcExpires":""};
var st=(function(e){
	var _self = this;
	var config = {};
	/*获取cookie*/
	...
	var __getJSON=function(url,callbackFn){
	...
	var _createActionSeqId = function( args ){
		...
		__getJSON(args.memcServerPath+"&key=channel_expires_"+args.stat_openid,"_memcTime");
		__getJSON(args.memcServerPath+"&key=channel_"+args.stat_openid,"_returnBackMemc");
