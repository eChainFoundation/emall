...
(function () {
    ...
    */
    window.UEDITOR_CONFIG = {
        ...
        //屏幕截图配置区
        , snapscreenHost: '192.168.1.167'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
...
//                        'print', 'preview', 'searchreplace']
        ["Bold", "Italic", "Underline", "strikethrough", "InsertUnorderedList", "InsertOrderedList", "InsertImage", "RemoveFormat", "FontSize", "ForeColor", "BackColor", "emotion", "link", "date"]
        ]
        ...
        , labelMap: {
            ...
            //            'bold': '', 'italic': '', 'underline': '', 'insertunorderedlist': '', 'insertorderedlist': '', 'insertimage': '', 'removeformat': '', 'forecolor': '', 'backcolor': ''
        }
