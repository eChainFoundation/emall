...
(function (e) {
	...
	function et(e, t, n) {
		var i = r(Math.abs(e) / 1000), s = r(i / 60), o = r(s / 60), u = r(o / 24), a = r(u / 365), f = i < 45 && ["s", i] || s === 1 && ["m"] || s < 45 && ["mm", s] || o === 1 && ["h"] || o < 22 && ["hh", o] || u === 1 && ["d"] || u <= 25 && ["dd", u] || u <= 45 && ["M"] || u < 345 && ["MM", r(u / 30)] || a === 1 && ["y"] || ["yy", a];
	...
	A.DDDD = O(A.DDD, 3), _.prototype = {set:function (e) {
		...
		for (n = 0; n < 12; n++) {
			this._monthsParse[n] || (r = t([2000, n]), i = "^" + this.months(r, "") + "|^" + this.monthsShort(r, ""), this._monthsParse[n] = new RegExp(i.replace(".", ""), "i"));
	...
	st("Weeks", 604800000), t.lang("en", {ordinal:function (e) {
