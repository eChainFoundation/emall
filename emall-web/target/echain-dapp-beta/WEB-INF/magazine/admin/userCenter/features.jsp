        ...
        <div class="container-fluid">
		  ...
		  <div class="box">
            ...
            <div class="row-fluid">
                            ...
                            <h5>微会员卡
通过在走农家微信平台内植入会员卡，帮助企业建立新一代的移动会员管理系统。清晰记录企业用户的消费行为并进行数据分析;还可根据用户特征进行精细分类，从而实现各种模式的精准营销。</h5>
...
(SCRM)-->
                        ...
                        <div id="hmyTabContent" class="tab-content">
                            ...
                            <dl>
                                ...
                                <dt class="span7">
                                <p>会员卡设置是指商家通过在走农家微信平台内植入会员卡，对会员卡的设置来管理会员。</p>
                                <h3>使用方法：</h3>
                            ...
                            <dl>
                                 <dt class="span7">
                                <p>会员管理是指商家可以通过走农家微信平台后台查看到用户领取会员卡的记录。</p>
                                <h3>使用方法：</h3>
                            ...
                            <dl>
                            <dt class="span7">
                                <p>消费管理是指商家可以通过走农家微信平台后台查看到用户消费管理的信息。</p>
                                <h3>使用方法：</h3>
                            ...
                            <dl>
                                ...
                                <dt class="span7">
                                <p>数据统计是指商家可以通过走农家微信后台查询最近一个月新增会员的趋势和最近一个月消费次数趋势的走向图。</p>
                                <h3>使用方法：</h3>
                            ...
                            <dl>
                                ...
                                <dt class="span7">
                                <p>门店设置是指商家通过走农家微信平台设置自己的商铺信息，从而让用户更加详细的了解商家的确切资料</p>
                                <h3>使用方法：</h3>
                         ...
                         <div class="box">
                          ...
                          <div class="box-content">
                            <dl>
                                ...
                                <dt class="span6">
                                 <p>走农家微信全国首创微网站，用户只要通过简单的设置，就能快速生成属于您自己的微网站，并且支持顶部导航、各种精美模板，供您选择，可以设计出自己的风格，让您的粉丝有种惊艳的感觉。</p>
					  ...
					  <!--
                        ...
                        <div class="box">
                             <div class="box-title">
                                        <h4 class="text-warning"><strong class="text-info">微医疗：</strong>是指通过走农家微信平台实现在线挂号、内容设置、预约查询、预约统计的一整套服务体系，能够有效解决患者挂号难、排队累、就医不方便等一系列难题。</h4>
                              </div>
                        ...
                        <div class="box-content">
                            <dl>
                               <dd class="span5"><img src="micromed.png"></dd>
                                <dt class="span7">
                                    <p>微医疗是指通过走农家微信平台实现在线挂号、内容设置、预约查询、预约统计的一整套服务体系，能够有效解决患者挂号难、排队累、就医不方便等一系列难题。</p>
                        ...
                        <div class="box">
                             <div class="box-title">
                                        <h4 class="text-warning"><strong class="text-info">微相册：</strong>微相册作为走农家微信平台的一项主打基本功能，为走农家微信用户提供图片的存储和展示服务，同时拓展成为基于图片兴趣分享的社区型产品。在微相册里，你可以方便的创建相册，轻松地发布你的照片，方便你与家人、朋友分享快乐、感动和成长…还可以拓展为商家开展活动的一种展现方式。</h4>
                              </div>
                ...
                <dl>
                 <dd class="span5"><img src="wxc.png"></dd>
                	<dt class="span7">
					     ...
					     <div class="box">
                          ...
                          <div class="box-content">
                            <dl>
                                ...
                                <dt class="span6">
                                 <p>微投票 通过在走农家微信平台内植入微投票，商家采用投票的活动来吸引用户，与用户之间产生互动，从而促进企业营销的一种手段。</p>
								 <p>使用方法：</p>
                        ...
                        <div class="box">
                             <div class="box-title">
                                        <h4 class="text-warning"><strong class="text-info">微调研：</strong>是一种以问卷调查的方式，基于走农家微信平台而展现出的一种新的在线调研应用方式，您可以在调研您相关行业的知名度、您想调研的任何行业认知度，具备有对微信用户进行生活形态研究的能力，受到行业客户的一致认可。</h4>
                              </div>
                ...
                <!-- <dd class="span5"><img src="wdy.png"></dd> -->
                	<dt class="span7">
                        ...
                        <p>6、进入题库管理：设置题目名称、编辑选项、设置题目答案(至少2项)，点击保存即可。</p>
						 ...
						 <div class="box">
                             <div class="box-title">
                                        <h4 class="text-warning"><strong class="text-info">微预约：</strong>是一种在线预约的方式，基于走农家微信平台而展现出的一种新的预订方式，您可以在线预订医院、商场、影院等各个领域 ，方便快捷，受到微信用户的一致好评。</h4>
                              </div>
                      ...
                      <dd class="span5"><img src="wxt.png"></dd> 
                        ...
                        <div class="box">
                             <div class="box-title">
                                        ...
                                        <h4>微汽车采用走农家微信平台进行汽车的销售管理、预约保养、预约试驾、保险计算、车贷计算、车型比较、违章查询等功能，整个过程非常便捷，省时省力省心，并通过与走农家微信平台有交互能力的手机客户端，快速便捷的实现了商家的销售管理与预约过程，同时也实现了客户无需进入4s店就能进行预约保养和试驾的功能。 </h4>
                              </div>
